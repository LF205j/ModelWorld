...
<body>
    ...
    <section class="container">
        <img src="img/EscalaTanque.jpg" width="100%" height="600px" alt="Inicio">
        <p>Tanques</p>
    </section>
    ...
    <div id="conteItemsCarrusel">
        <div class="itemCarrusel" id="itemCarrusel-1">
            <div class="tarjetaCarrusel" id="tarjetaCarrusel-1">
                <img src="img/Tanque1.jpg" alt="imagen 1">
            </div>
        ...
        <div class="itemCarrusel" id="itemCarrusel-2">
            <div class="tarjetaCarrusel" id="tarjetaCarrusel-2">
                <img src="img/Tanque2.jpg" alt="imagen 2">
            </div>
            <div class="flechasCarrusel">
        ...
        <div class="itemCarrusel" id="itemCarrusel-3">
            <div class="tarjetaCarrusel" id="tarjetaCarrusel-3">
                <img src="img/Tanque3.jpg" alt="imagen 3">
            </div>
            <div class="flechasCarrusel">
                <a href="#itemCarrusel-2">
                    <i class="fa-solid fa-chevron-left"></i>
...
<div class="compra"> 
    <table align="center" cellspacing="25" >
        ...
        <tr> <td><b ><img src="img/Venta1Tanque.jpg" height="225px" width="260px" href="TrenEscala.php"/></b></td>   <td><b href="AvionEscala.php"><img src="img/Venta2Tanque.jpg" height="225px" width="260px"/></b></td>       </tr>
        <tr><td><h4 href="">Trumpeter 1:35 1522 British Challenger 2 Enhanced Armour </h4><center><h5>Precio: $15.000</h5></center></td> <td><h4 href="">Trumpeter 1:35 1559 M1133 Stryker MEV  </h4><center><h5>Precio: $15.000</h5></center></td></tr>
        <tr> <td><a href="Escalas/TrenEscala.php">Comprar</a></td>   <td><a href="Escalas/AvionEscala.php">Comprar</a></td>      </tr>
        
        <tr><td><b href="Plastimodelismo.php"><img src="img/Venta3Tanque.jpg" width="260px" height="225px"/></b></td> <td><b href="Plastimodelismo.php"><img src="img/Venta4Tanque.jpg" width="260px" height="225px"/></b></td>  </tr>
        <tr><td><h4 href="">Trumpeter 1:35 1571 Soviet Su-152 Self Propelled Heavy Howitzer </h4><center><h5>Precio: $15.000</h5></center></td> <td><h4 href="">Trumpeter 1:35 5535 ASLAV-PC Phase 3 Austrailian LAV</h4><center><h5>Precio: $15.000</h5></center></td></tr>
