...
<body>
    ...
    <section class="container">
        <img src="img/AvionFondo.jpg" width="100%" height="600px" alt="Inicio">
        <p>Aviones</p>
    </section>
    ...
    <div id="conteItemsCarrusel">
        <div class="itemCarrusel" id="itemCarrusel-1">
            <div class="tarjetaCarrusel" id="tarjetaCarrusel-1">
                <img src="img/Avion1.jpg" alt="imagen 1">
            </div>
        ...
        <div class="itemCarrusel" id="itemCarrusel-2">
            <div class="tarjetaCarrusel" id="tarjetaCarrusel-2">
                <img src="img/Avion2.jpg" alt="imagen 2">
            </div>
            <div class="flechasCarrusel">
        ...
        <div class="itemCarrusel" id="itemCarrusel-3">
            <div class="tarjetaCarrusel" id="tarjetaCarrusel-3">
                <img src="img/Avion3.jpg" alt="imagen 3">
            </div>
            <div class="flechasCarrusel">
                <a href="#itemCarrusel-2">
                    <i class="fa-solid fa-chevron-left"></i>
...
<div class="compra"> 
    <table align="center" cellspacing="25" >
        ...
        <tr> <td><b ><img src="img/Venta1Avion.jpg" height="225px" width="260px" href="TrenEscala.php"/></b></td>   <td><b href="AvionEscala.php"><img src="img/Venta2Avion.jpg" height="225px" width="260px"/></b></td>       </tr>
        <tr><td><h4 href="">Revell 1:144 4945 Boeing 777-300ER </h4><center><h5>Precio: $15.000</h5></center></td> <td><h4 href="">Revell 1:48 4662 Lockheed PV-1 Ventura </h4><center><h5>Precio: $15.000</h5></center></td></tr>
        <tr> <td><a href="Escalas/TrenEscala.php">Comprar</a></td>   <td><a href="Escalas/AvionEscala.php">Comprar</a></td>      </tr>

        <tr><td><b href="Plastimodelismo.php"><img src="img/Venta3Avion.jpg" width="260px" height="225px"/></b></td> <td><b href="Plastimodelismo.php"><img src="img/Venta4Avion.jpg" width="260px" height="225px"/></b></td>  </tr>
        <tr><td><h4 href="">Zvezda 1:72 7321 Lockheed C-130H Hercules</h4><center><h5>Precio: $15.000</h5></center></td> <td><h4 href="">Trumpeter 1:72 1639 FW200 C-8 Condor  </h4><center><h5>Precio: $15.000</h5></center></td></tr>
